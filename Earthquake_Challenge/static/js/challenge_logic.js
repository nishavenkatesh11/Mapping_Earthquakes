...
// We create the second tile layer that will be the background of our map.
let dark_navigation = L.tileLayer('https://api.mapbox.com/styles/mapbox/navigation-night-v1/tiles/{z}/{x}/{y}?access_token={accessToken}', {
	attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery (c) <a href="https://www.mapbox.com/">Mapbox</a>',
	maxZoom: 18,
	accessToken: API_KEY
});
...
let baseMaps = {
  ...
  "Dark Navigation": dark_navigation
};
...
L.geoJson(data, {
  ...
  style: styleInfo,
  onEachFeature: function(feature, layer) {
    layer.bindPopup("<h4>Magnitude: </h4>" + feature.properties.mag + "<br><h4>Location: </h4>" + feature.properties.place);
  }
